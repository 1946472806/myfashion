...
urlpatterns = [
    ...
    url(r'^delcar/$', views.delcar, name='delcar'),#删除已选购的商品
    url(r'^placeorder/$', views.placeorder, name='placeorder'),  # 下单
    url(r'^collection/$', views.collection, name='collection'),#添加收藏
    url(r'^iscollection/$', views.iscollection, name='iscollection'),#判断是否已经收藏

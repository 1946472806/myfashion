...
class GoodsCar(models.Model):
    ...
    @classmethod
    def creategoodscar(cls,tel,img,wen,said1,said2,unit,num,price_good):
        goodscar = cls(u_tel=tel,img=img,wen=wen,said1=said1,said2=said2,unit=unit,num=num,price_good=price_good)
        return goodscar